...
public class Teacher extends Person implements Employee{
    ...
    /**
     * Teacher constructor with custom pALAmters
     * @pALAm name specifies Person name
     * @pALAm age specifies Person age
     * @pALAm certification specifies if teacher is certified or not
     * @pALAm gradeLevel specifies what grade level the teacher teaches at
     */
